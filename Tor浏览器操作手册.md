...
（1）下载tor-browser-windows-x86_64-portable-15.0.4软件并安装

## **3.软件配置**

### **3.1获取VPN软件代理端口和协议**

（1）VPN代理模式设置为自动配置系统代理，建议使用Clash和V2rayN等软件的订阅服务（便于获取代理端口信息）。

（2）找到代理软件代理端口和代理协议信息。也可以通过计算机Internet选项-连接-局域网设置，获取代理软件端口（协议为Socks5或HTTP，具体看软件设置，比如V2rayN10808为混合端口，两个协议都可以使用）

![1774951603003](image/Tor浏览器操作手册/1774951603003.png)

![1774943738285](image/Tor浏览器操作手册/1774943738285.png)

### **3.2 配置Tor浏览器前置代**理

Tor浏览器前置代理配置（使其能访问外网，这样网桥才能正常工作）

![1774943424714](image/Tor浏览器操作手册/1774943424714.png)

### **3.2 配置Tor浏览器网桥**

获取网桥方法如下

方法1：查找更多网桥-请求网桥，自动获取网桥。

方法2：更换网桥，输入文档第4章节提供的可选网桥地址（推荐obfs网桥）

![1774944104220](image/Tor浏览器操作手册/1774944104220.png)

## **4.连接到Tor网络**

点击连接，进度加载完毕显示如下界面表示配置成功（初次连接速度较慢，需要几分钟），浏览器已连接到Tor网络。

![1774952047061](image/Tor浏览器操作手册/1774952047061.png)

## **5.访问洋葱站点**

在上方搜索窗口输入洋葱网站网址即可访问

![1774952609499](image/Tor浏览器操作手册/1774952609499.png)
...
## **6.可选网桥地址（Tor Broswer PC版和安卓版也可用）**
